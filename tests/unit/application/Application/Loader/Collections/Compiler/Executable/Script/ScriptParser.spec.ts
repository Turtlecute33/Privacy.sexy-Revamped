...
import { parseScript } from '@/application/Application/Loader/Collections/Compiler/Executable/Script/ScriptParser';
import { type DocsParser } from '@/application/Application/Loader/Collections/Compiler/Executable/DocumentationParser';
...
import type { ExecutableValidatorFactory } from '@/application/Application/Loader/Collections/Compiler/Executable/Validation/ExecutableValidator';
...
import type { ScriptErrorContext } from '@/application/Application/Loader/Collections/Compiler/Executable/Validation/ExecutableErrorContext';
...
import { itThrowsContextualError } from '@tests/unit/application/Application/Loader/Collections/Compiler/Common/ContextualErrorTester';
...
import type { ObjectAssertion } from '@/application/Common/TypeValidator';
